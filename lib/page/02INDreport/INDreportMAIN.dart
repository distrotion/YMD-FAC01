                        ...
                        children: [
                          ...
                          for (int i = 0; i < _datatable.length; i++) ...[
                            ...
                            MasterTableDATA(
                              ...
                              AcidWashing10Temp:
                                  _datatable[i].AcidWashing10Temp,
                              AcidWashing10Time:
                                  _datatable[i].AcidWashing10Time,
                              ...
                              CoperSulfate24Volt:
                                  _datatable[i].CoperSulfate24Volt,
                              CoperSulfate24Amp:
                                  _datatable[i].CoperSulfate24Amp,
                              CoperSulfate24Temp:
                                  _datatable[i].CoperSulfate24Temp,
                              CoperSulfate24Rpm:
                                  _datatable[i].CoperSulfate24Rpm,
                              CoperSulfate024Time:
